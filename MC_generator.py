...
def MC_Generator(net_grid, blocks, steps):
	'''
	This is a Monte Carlo based random board generator. I am trying to use a Monte carlo methodology instead of
	the usual iterative recursive methodology because I believe that Monte carlo with some smart intelligent bias will be faster to parse.
